...
from .views import BoothView, SugerenciaVista, send_suggesting_form, LogoutView, LoginView, loginformpost
...
urlpatterns = [
    ...
    path('inicio/<int:voting_id>/', BoothView.as_view(), name="votacion"),
